...
//mongoose.connect("mongodb+srv://udayakumar:Kalaradha@2001@cluster0.53saned.mongodb.net/").then(console.log("db connected"))

const uri = "mongodb+srv://udaya:Vaishu@cluster0.54nhuir.mongodb.net/"
...
app.post('/adimiregister', async (req, res) => {
